...
var AST_Raw, AttachedCache, Conditions, Revision, RuleList, ShexpUtils, U2, ref1, extend = function (child, parent) { for (var key in parent) {
        ...
        'RuleListProfile': {
            ...
            update: function (profile, data) {
                ...
                for (formatName in RuleList) {
                    if (!hasProp.call(RuleList, formatName))
                        continue;
