...
[![Firefox Supported - Click to Add](https://img.shields.io/badge/Firefox-Supported%20%C2%B7%20Click%20to%20Add-FF7139?logo=firefoxbrowser&logoColor=white)](https://addons.mozilla.org/firefox/addon/switchyagain/)
<br>
...
| Area | SwitchyOmega | SwitchyAgain |
| --- | --- | --- |
...
| Popup profile switching | Supported | Supported |
| Context menu profile switching | Supported | Supported |
| Tab profile scope | Not available | Supported |
| Tab group profile scope | Not available | Supported |
| Container profile scope | Not available | Supported |
| Normal/private window profile scope | Supported | Supported |
| Context menu profile icons | Text labels | Icons |
