...
if (!entry || !outfile || (format === 'iife' && !globalName)) {
  throw new Error(
    'Usage: node scripts/bundle-esbuild.mjs --entry=<file> --outfile=<file> [--format=cjs|iife] [--global-name=<name>] [--platform=browser|node] [--target=es2022] [--external=a,b] [--alias=a=b,c=d] [--minify]'
  );
}
