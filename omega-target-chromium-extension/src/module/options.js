...
// @ts-nocheck
var ChromeOptions, ChromePort, OmegaPac, OmegaTarget, Promise, Url, WebRequestMonitor, fetchUrl, querystring, extend = function (child, parent) { for (var key in parent) {
    ...
    ChromeOptions.prototype.updateProfile = function () {
        ...
        return ChromeOptions.__super__.updateProfile.apply(this, args).then(function (results) {
            ...
            for (profileName in results) {
                if (!hasProp.call(results, profileName))
                    continue;
